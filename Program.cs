...
namespace pragueparking
{
	class Program
	{
		static string[] parkingGarage = new string[100]; // Array för p-platser 

		static void Main(string[] args)
		{
			bool run = true; //för att snurran ska fungera måste vi veta att den är sann. 
			while (run)
			{
				// Display meny
				Console.Clear();
		...
		// Metoder kopplade till switchsatsen
		...
		// Metod: Identifiera fordon baserat på regnummer
		...
		// Metod: Välj vilket fordon du vill flytta
		...
		//Metod: Lista för Parkingsplaster
